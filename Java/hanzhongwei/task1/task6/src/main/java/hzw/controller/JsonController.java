...
public class JsonController {
    ...
    @RequestMapping(value = "/json/login1",method = RequestMethod.GET)
    public String jsonLogin12(Model model){
        logger.info("进入json登陆==================");
        List<Profession> profession =  serviceRedis.findListProfession();
        model.addAttribute("profession",profession);
        return "professionJson";
    }
