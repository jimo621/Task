        ...
        <div class="row advantage">
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
                <div class="count">
                    ...
                    <p><a class="glyphicon glyphicon-user"> ${a}</a><a class="f3">累计在线学习人数</a></p>
        ...
        <div class="container showone">
            <div class="row">
                <c:forEach items="${stu}" var="s">
                    <c:if test="${s.stuSuper==1}">
                        <div class="col-md-6 col-lg-3 col-xs-12">
                            <div class="students">
                                <img class="img-circle" src="img/Avatar.png">
                                <span class="title">${s.stuProfession}：${s.stuName}</span>
                                <div>
                                    <p>${s.stuIntroduction}</p>
                                    <p><date:date value="${s.update_at}"/></p>
                                </div>
                            </div>
                        </div>
                    </c:if>
