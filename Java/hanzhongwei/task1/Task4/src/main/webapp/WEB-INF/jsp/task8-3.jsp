            ...
            <div class="col-lg-4 carrer1">
                ...
                <table class="table table-bordered table1">
                    ...
                    <tr>
                        <td class="grey">门槛
                            <%--循环星星--%>
                            <c:forEach begin="1" end="${p.proThreshold}">
                                <img src="../../img/star.png">
                            </c:forEach>
                        </td>
                        <td class="grey">难易程度
                                <%--循环星星--%>
                            <c:forEach begin="1" end="${p.proDifficulty}">
                                <img src="../../img/star.png">
                            </c:forEach>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="grey">稀缺程度<span class="red">${p.proCompany}</span>家公司需要</td>
                    </tr>
                    <tr>
                        <th rowspan="3" class="salary">薪资待遇</th>
                        <td class="money"><span>0-1年</span><span>${p.proSalary_min}k-${p.proSalary_max}k/月</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th colspan="2">有<span class="red1">${p.proType}人</span>在学</th>
                    </tr>
                    <tr>
